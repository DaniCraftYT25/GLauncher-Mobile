...
public class CustomControls {
	...
	public static CustomControls getGamepadTemplate(Context context, int template) {
		if (template == 1) {
			return getGamepadTemplateB(context);
		}

		return getGamepadTemplateA(context);
	}

	private static CustomControls getGamepadTemplateA(Context context) {
		CustomControls controls = new CustomControls();

		controls.mJoystickDataList.add(new ControlJoystickData(
				context,
				new int[] { ControlJoystickData.JOY_LEFT },
				"${margin}",
				"screen_height - width - margin",
				false,
				false,
				false,
				true
		...
		controls.mJoystickDataList.add(new ControlJoystickData(
				context,
				new int[] { ControlJoystickData.JOY_RIGHT },
	...
	private static CustomControls getGamepadTemplateB(Context context) {
		CustomControls controls = new CustomControls();
